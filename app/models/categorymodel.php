...
<?php 
	...
	class categorymodel extends DModel{
		...
		public function getproductbyid($table,$cond){
			$sql = "SELECT * FROM $table WHERE id_product=$cond";
			return $this->db->select($sql);
		}
		public function productpricebyid($table,$cond){
			$sql = "SELECT price_product FROM $table WHERE $cond";
			return $this->db->select($sql);
		}
