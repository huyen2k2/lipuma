<style>
    .thongke .app-theme-white.app-container {
        background: #fff;
    }
    .thongke .fixed-sidebar .app-main .app-main__outer {
        padding-left: 0;
    }
    .thongke .app-main .app-main__inner {
        padding: 0;
        background: red;
    }
		.thongke .container {
...
<section id="thongke" class="thongke">
    <div class="container">
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                               <form action="<?php echo BASE_URL ?>/thongke/thongke" method="POST">
                ...
                <div class="row">
                        ...
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                ...
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-white"><span><?php echo (count($data['today']) - 1) . " đơn"; ?></span></div>
                                    <div class="widget-numbers text-white"><span><?php echo number_format($data['today']['total'],0,',','.').'đ';?></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    <div class="widget-heading">Month <?php echo date('m');?></div>
                                    <div class="widget-subheading">Total Order</div>
                                </div>
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-white"><span><?php echo (count($data['month']) - 1) . " đơn"?></span></div>
                                    <div class="widget-numbers text-white"><span><?php echo number_format($data['month']['total'],0,',','.').'đ'; ?></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    <div class="widget-heading">Custom</div>
                                    <div class="widget-subheading">Total Order</div>
                                </div>
                                <?php if(isset($data['custom_time'])) : ?>
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-white"><span><?php echo (count($data['custom_time']) - 1) . " đơn"; ?></span></div>
                                        <div class="widget-numbers text-white"><span><?php echo number_format($data['custom_time']['total'],0,',','.').'đ'; ?></span></div>
                                    </div>
                                <?php else:?>
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-white"><span><?php echo (count($data['month']) - 1) . " đơn"; ?></span></div>
