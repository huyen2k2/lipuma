...
<?php
  ...
  ?> 
<table class="table table-striped" style = "margin-left: 280px; font-size: 16px; width: 73%;">
    <thead>
      <tr>
        <th>Id</th>
        <th>Tên </th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo BASE_URL ?>/product/delete_product/<?php echo $pro['id_product'] ?>"><i class="fa-solid fa-trash"></i></a> || <a href="<?php echo BASE_URL ?>/product/edit_product/<?php echo $pro['id_product'] ?>"><i class="fa-solid fa-pen"></i></a></td>
      </tr>
      <?php
      } 
      ?>
