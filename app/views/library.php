...
define("SMTP_UNAME", "minhthuyictu@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "ugpzdmndlcdhwehg"); //Password for SMTP authentication
